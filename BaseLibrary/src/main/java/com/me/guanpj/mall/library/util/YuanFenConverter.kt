...
object YuanFenConverter {
    ...
    /*
      元 转换为 分
     */
    fun changeY2F(amount: Long?): String = BigDecimal.valueOf(amount!!).multiply(BigDecimal(100)).toString()
    ...
    /*
      分 转换为 元，带单位
     */
    fun changeF2YWithUnit(amount: Long): String = "¥${YuanFenConverter.changeF2Y(amount)}"
}
