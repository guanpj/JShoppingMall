...
import com.me.guanpj.mall.goods.module.category.CategoryContract
...
class CategoryPresenter @Inject constructor() : BasePresenter<CategoryContract.View>(), CategoryContract.Presenter {
    ...
    fun getCategory(parentId:Int) {
        ...
        getView().showLoading()
        categoryService.getCategory(parentId).excute(object : BaseSubscriber<MutableList<Category>?>(getView()) {
